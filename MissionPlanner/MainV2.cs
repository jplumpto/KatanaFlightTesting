...
/// </summary>
        ...
        public MainV2()
        {
            ...
            try
            {
                ...
                KatanaView = new GCSViews.Katana();
        ...
        private void MainV2_Load(object sender, EventArgs e)
        {
            ...
            MyView.AddScreen(new MainSwitcher.Screen("Help", new GCSViews.Katana(), false));

            MyView.AddScreen(new MainSwitcher.Screen("KatanaView", KatanaView, true));
...
new System.Net.Security.RemoteCertificateValidationCallback((sender, certificate, chain, policyErrors) => { return true; });
        ...
        public void changelanguage(CultureInfo ci)
        {
            if (ci != null && !Thread.CurrentThread.CurrentUICulture.Equals(ci))
            {
                ...
                HashSet<Control> views = new HashSet<Control> { FlightData, FlightPlanner, Simulation, KatanaView };
        ...
        private void MenuAux_Click(object sender, EventArgs e)
        {
            // Load form to connect Crossbow
            Form temp = new RAW_Sensor(); //Create form for accessing auxiliary devices
            ThemeManager.ApplyThemeTo(temp);
            temp.Show();
        }

        private void MenuKatana_Click(object sender, EventArgs e)
        {
            MyView.ShowScreen("KatanaView");
        }
    }
}