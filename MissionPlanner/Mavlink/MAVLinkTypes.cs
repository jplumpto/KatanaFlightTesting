...
namespace ArdupilotMega
{
    ...
    partial class MAVLink
    {
        ...
        //KatanaFlightTesting
        public const byte MAVLINK_MSG_ID_RAW_KATANA = 65;
        [StructLayout(LayoutKind.Sequential, Pack = 1, Size = 46)]
        public struct mavlink_raw_katana_t
        {
            public UInt32 time_boot_ms; ///< Timestamp (milliseconds since system boot)
            public Int16 stick_xacc; ///< X acceleration (raw)
            public Int16 stick_yacc; ///< Y acceleration (raw)
            public Int16 stick_zacc; ///< Z acceleration (raw)
            public Int16 stick_xgyro; ///< Angular speed around X axis (raw)
            public Int16 stick_ygyro; ///< Angular speed around Y axis (raw)
            public Int16 stick_zgyro; ///< Angular speed around Z axis (raw)
            public Int16 stick_xmag; ///< X Magnetic field (raw)
            public Int16 stick_ymag; ///< Y Magnetic field (raw)
            public Int16 stick_zmag; ///< Z Magnetic field (raw)
            public Int16 rudder_xacc; ///< X acceleration (raw)
            public Int16 rudder_yacc; ///< Y acceleration (raw)
            public Int16 rudder_zacc; ///< Z acceleration (raw)
            public Int16 rudder_xgyro; ///< Angular speed around X axis (raw)
            public Int16 rudder_ygyro; ///< Angular speed around Y axis (raw)
            public Int16 rudder_zgyro; ///< Angular speed around Z axis (raw)
            public Int16 rudder_xmag; ///< X Magnetic field (raw)
            public Int16 rudder_ymag; ///< Y Magnetic field (raw)
            public Int16 rudder_zmag; ///< Z Magnetic field (raw)
            public Int16 stick_pot1; ///< Stick deflection pot 1 (raw)
            public Int16 stick_pot2; ///< Stick deflection pot 2 (raw)
            public Int16 rudder_pot; ///< Rudder deflection pot (raw)
