...
namespace ArdupilotMega
{
    public class CurrentState : ICloneable
    {
        ...
        public float stick_mx { get; set; }
        [DisplayText("Stick Mag Y")]
        public float stick_my { get; set; }
        ...
        public float rudder_mx { get; set; }
        [DisplayText("Rudder Mag Y")]
        public float rudder_my { get; set; }
        [DisplayText("Rudder Mag Z")]
        public float rudder_mz { get; set; }
        // string pots
        [DisplayText("Stick Pot 1")]
        public float stick_pot1 { get; set; }
        [DisplayText("Stick Pot 2")]
        public float stick_pot2 { get; set; }
...
enum gcs_severity {
    ...
    SEVERITY_CRITICAL
                    ...
                    bytearray = mavinterface.MAV.packets[MAVLink.MAVLINK_MSG_ID_RAW_KATANA];
                    if (bytearray != null)
                    {
                        ...
                        rudder_my = katana.rudder_ymag;
                        rudder_mz = katana.rudder_zmag;
                        stick_pot1 = katana.stick_pot1;
                        stick_pot2 = katana.stick_pot2;
                        rudder_pot = katana.rudder_pot;
